...
$options = array(
		'token'=>'maizhitian', //填写你设定的key
		'appid'=>'wxffb1c042684061dd', //填写高级调用功能的app id, 请在微信开发模式后台查询
		'appsecret'=>'7e4a7c05edd2737e5d596a8ca187c278', //填写高级调用功能的密钥
);
$auth = new wxauth($options);

//var_dump($auth->wxuser);
$cookie_time = time() + 86400 * 60;//记住登陆2个月
setcookie(OPENID,      AuthCode($auth->wxuser['open_id'], 'ENCODE'), $cookie_time);
$curl = getCookieByKey('url');
redirect($curl);
exit();
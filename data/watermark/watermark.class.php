...
function WaterMark($groundimage, $markimage, $markminwidth, $markminheight, $markwhere = '0', $marktext = 'weixin66.net', $fontfamily = '黑体', $fontsize = '15', $fontcolor = "#000", $marktype = 0) {

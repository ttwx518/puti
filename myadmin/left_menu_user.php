...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="quickBtn">
            <span class="quickBtnLeft"><a href="infolist_add.php" target="main">添列表</a></span>
            <span class="quickBtnRight"><a href="infoimg_add.php" target="main">添图片</a></span>
        </div>
            ...
            <div class="viewport">
                <div class="overview">
                    ...
                    if (empty($modelPriv)) {
                        ...
                        //构成管理菜单数组
                        $leftMenu01_Str = '';
                        $leftMenu01_Arr = array(
                            'admin' => '<a href="admin.php" target="main">管理员管理</a>',
                        ...
                        $leftMenu02_Str = '';
                        $leftMenu02_Arr = array(
                            'infoclass' => '<a href="infoclass.php" target="main">栏目管理</a>',
                        ...
                        $leftMenu03_Str = '';
                        $leftMenu03_Arr = array(
                            'member' => '<a href="member.php" target="main">用户管理</a>',
                            'usergroup' => '<a href="usergroup.php" target="main" title="用户组管理" class="usertype"></a>',
                            'withdrawApply' => '<a href="withdrawApply.php" target="main" title="提现申请管理">提现申请管理</a>',
                            'withdrawRecord' => '<a href="withdrawRecord.php" target="main" title="提现记录管理">提现记录管理</a>',
                            'commissionRanking' => '<a href="commissionRanking.php" target="main" title="佣金排行统计">佣金排行统计</a>',
                            'userfavorite' => '<a href="userfavorite.php" target="main">用户收藏管理</a>',
                            'usercomment' => '<a href="usercomment.php" target="main">用户评论管理</a>',
                            'integralrule' => '<a href="integralrule.php" target="main">积分规则管理</a>',
                        ...
                        $leftMenu04_Str = '';
                        $leftMenu04_Arr = array(
                            'goodstype' => '<a href="goodstype.php" target="main">商品类别管理</a>',
                        ...
                        $leftMenu05_Str = '';
                        $leftMenu05_Arr = array(
                            'mobile' => '<a href="mobile.php" target="main">手机网站设置</a>',
                            'nav' => '<a href="nav.php" target="main">导航菜单设置</a>',
                            'editfile' => '<a href="editfile.php" target="main">默认模板管理</a>'
                            );
                        $leftMenu06_Str = '';
                        $leftMenu06_Arr = array(
                            'syscount' => '<a href="syscount.php" target="main">数据统计</a>',
                        ...
                        if ($leftMenu03_Str != '') {
                            //如果02菜单为空，初始化03菜单
                            if ($leftMenu01_Str != '' or $leftMenu02_Str != '') {
                        ...
                        if ($leftMenu04_Str != '') {
                            //如果03菜单为空，初始化04菜单
                            if ($leftMenu01_Str != '' or $leftMenu02_Str != '' or $leftMenu03_Str != '') {
                        ...
                        if ($leftMenu05_Str != '') {
                            //如果04菜单为空，初始化05菜单
                            if ($leftMenu01_Str != '' or $leftMenu02_Str != '' or $leftMenu03_Str != '' or $leftMenu04_Str != '') {
                                echo '<div class="menubox"><div class="title" onclick="DisplayMenu(\'leftmenu05\');" title="点击切换显示或隐藏"> 查询统计管理 </div><div id="leftmenu05" style="display:none">';
                            } else {
                                echo '<div class="menubox"><div class="title on" id="t1" onclick="DisplayMenu(\'leftmenu05\');" title="点击切换显示或隐藏"> 查询统计管理 </div><div id="leftmenu05">';
                            }
                        ...
                        if ($leftMenu06_Str != '') {
                            //如果05菜单为空，初始化06菜单
                            if ($leftMenu01_Str != '' or $leftMenu02_Str != '' or $leftMenu03_Str != '' or $leftMenu04_Str != '' or $leftMenu05_Str != '') {
                                echo '<div class="menubox"><div class="title" onclick="DisplayMenu(\'leftmenu06\');" title="点击切换显示或隐藏"> 界面模板管理 </div><div id="leftmenu06" style="display:none">';
                            } else {
                                echo '<div class="menubox"><div class="title on" id="t1" onclick="DisplayMenu(\'leftmenu06\');" title="点击切换显示或隐藏"> 界面模板管理 </div><div id="leftmenu06">';
                            }
        ...
        <div class="copyright">
            © 2014 <a href="http://weixin66.net/" target="_blank">weixin66.net</a><br />
            All Rights Reserved.
        </div>
        <div class="tabMenu">

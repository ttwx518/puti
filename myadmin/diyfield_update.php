        ...
        <form name="form" id="form" method="post" action="diyfield_save.php" onsubmit="return cfm_diyfield();">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                <tr>
                    ...
                    <td width="75%">
                        <select name="infotype" id="infotype" disabled="disabled">
                            <?php
                ...
                <tr>
                    ...
                    <td width="75%">
                        <input type="text" name="fieldname" id="fieldname" class="input" value="<?php echo $row['fieldname']; ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="fieldtitle" id="fieldtitle" class="input" value="<?php echo $row['fieldtitle']; ?>" />
                        <span class="maroon">*</span><span class="cnote">例如：文章标题</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="nb">
                            <tr>
                                <td height="30">
                                    <input type="radio" name="fieldtype" id="fieldtype" value="varchar" <?php if ($row['fieldtype'] == 'varchar') echo 'checked="checked"'; ?> disabled="disabled" />
                                    <strong>单行文本：</strong>字数较少，例如文章标题等；默认长度小于或等于 &quot;<span class="blue">255</span>&quot; [varchar]
                                </td>
                            </tr>
                            <tr>
                                <td height="30">
                                    <input type="radio" name="fieldtype" id="fieldtype" value="text" <?php if ($row['fieldtype'] == 'text') echo 'checked="checked"'; ?> disabled="disabled" />
                                    <strong>多行文本：</strong>字数偏多，类似于文章描述形式的多行文本；<span class="blue">字段长度留空</span> [text]
                                </td>
                            </tr>
                            <tr>
                                <td height="30">
                                    <input type="radio" name="fieldtype" id="fieldtype" value="mediumtext" <?php if ($row['fieldtype'] == 'mediumtext') echo 'checked="checked"'; ?> disabled="disabled" />
                                    <strong>编 辑 器 ：</strong>字数较多，输入框带编辑器大型文本，如文章内容；<span class="blue">字段长度留空</span> [mediumtext]
                                </td>
                            </tr>
                            <tr>
                                <td height="30">
                                    <input type="radio" name="fieldtype" id="fieldtype" value="int" <?php if ($row['fieldtype'] == 'int') echo 'checked="checked"'; ?> disabled="disabled" />
                                    <strong>整　　数：</strong>正负整数类型字段，如123456；长度默认为 &quot;<span class="blue">11</span>&quot; [int]
                                </td>
                            </tr>
                            <tr>
                                <td height="30">
                                    <input type="radio" name="fieldtype" id="fieldtype" value="radio" <?php if ($row['fieldtype'] == 'radio') echo 'checked="checked"'; ?> disabled="disabled" />
                                    <strong>单选菜单</strong>&nbsp;&nbsp;
                            ...
                            <tr>
                                <td height="30">
                                    <input type="text" name="fieldsel" id="fieldsel" class="input" value="<?php echo $row['fieldsel']; ?>" />
                                    单选、多选、下拉菜单填值，格式：&quot;选项=值&quot;，每个选项用&quot;,&quot;分割
                                </td>
                            </tr>
                            <tr>
                                <td height="30">
                                    <input type="radio" name="fieldtype" id="fieldtype" value="decimal" <?php if ($row['fieldtype'] == 'decimal') echo 'checked="checked"'; ?> disabled="disabled" />
                                    <strong>货　　币：</strong>如102.56；长度默认为 &quot;<span class="blue">10,2</span>&quot;，&quot;10&quot;代表值总长度，&quot;2&quot;代表小数位数 [decimal]
                                </td>
                            </tr>
                            <tr>
                                <td height="30">
                                    <input type="radio" name="fieldtype" id="fieldtype" value="datetime" <?php if ($row['fieldtype'] == 'datetime') echo 'checked="checked"'; ?> disabled="disabled" />
                                    <strong>日期时间：</strong>如2012-07-25 10:21:23，本系统日期格式为整型，所以系统会为您创建为整型字段；<span class="blue">字段长度留空</span> [int]
                                </td>
                            </tr>
                            <tr>
                                <td height="30">
                                    <input type="radio" name="fieldtype" id="fieldtype" value="file" <?php if ($row['fieldtype'] == 'file') echo 'checked="checked"'; ?> disabled="disabled" />
                                    <strong>单个附件：</strong>上传类型字段(如图片、文档等)，上传类型、大小等限制按系统附件设置执行；默认长度小于或等于 &quot;<span class="blue">100</span>&quot; [varchar]
                                </td>
                            </tr>
                            <tr>
                                <td height="30">
                                    <input type="radio" name="fieldtype" id="fieldtype" value="fileall" <?php if ($row['fieldtype'] == 'fileall') echo 'checked="checked"'; ?> disabled="disabled" />
                                    <strong>多个附件：</strong>可上传多个附件，类似于组图上传；<span class="blue">字段长度留空 </span>[text]
                                    <input type="hidden" name="fieldtype" id="fieldtype" value="<?php echo $row['fieldtype']; ?>" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="fieldlong" id="fieldlong" class="input" value="<?php echo $row['fieldlong']; ?>" />
                        <span class="maroon">*</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" name="fieldcheck" id="fieldcheck" class="input" value="<?php echo $row['fieldcheck']; ?>" />
                        <span class="cnote">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="fieldcback" id="fieldcback" class="input" value="<?php echo $row['fieldcback']; ?>" />
                ...
                <tr class="nb">
                    ...
                    <td>
                        ...
                        <label><input type="radio" name="checkinfo" value="false" <?php if ($row['checkinfo'] == 'false') echo 'checked="checked"'; ?> /> 禁用</label>
                    </td>
                </tr>
                <tr class="nb">

        ...
        <form name="form" id="form" method="post" action="message_save.php" onsubmit="return cfm_msg();">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="recont" id="recont"><?php echo $row['recont'] ?></textarea>
                        <script>
                            var editor;
                            KindEditor.ready(function(K) {
                ...
                <tr>
                    ...
                    <td>
                        <label><input type="checkbox" name="htop" id="htop" value="true" <?php if ($row['htop'] == 'true') echo 'checked="checked"'; ?> /> 置顶[h]</label>
                        <label><input type="checkbox" name="rtop" id="rtop" value="true" <?php if ($row['rtop'] == 'true') echo 'checked="checked"'; ?> /> 推荐[r]</label>
                    </td>
                </tr>
                <tr class="nb">

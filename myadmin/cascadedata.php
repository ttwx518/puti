...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="topToolbar">
            ...
            <span class="text">级联标识：<a href="cascade.php"><?php echo $signstr; ?></a></span>
                    ...
                    if ($dosql->GetTotalRow() > 0) {
                        while ($row = $dosql->GetArray()) {
                            ...
                            <tr align="left" class="dataTr">
                                ...
                                <td>
                                    <input type="text" name="dataname[]" id="dataname[]" class="inputd" value="<?php echo $row['dataname']; ?>" />
                                ...
                                <td class="action endCol">
                                    <a href="cascadedata_save.php?action=delclass&amp;sign=<?php echo $sign; ?>&amp;id=<?php echo $row['id']; ?>" onclick="return ConfDel(0);">删除</a>
                                </td>
                            </tr>
                            <?php
                        }
        ...
        <div class="bottomToolbar">
            <span class="selArea">
                ...
                <a href="javascript:SubUrlParam('cascadedata_save.php?action=delallclass');" onclick="return ConfDelAll(2);">删除</a>
                <span>操作：</span>
                <a href="javascript:UpOrderID('cascadedata_save.php');">更新排序</a>
            </span>

            ...
            <form name="form" id="form" method="post" action="infolist_save.php" onsubmit="return cfm_infolm();">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="auid" id="auid" class="input" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="goodsprice" id="goodsprice" class="input" />
                            <span class="cnote">活动必填</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="goodsunit" id="goodsunit" class="input" />
                            <span class="cnote">活动必填</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="goodstitle" id="goodstitle" class="input" />
                            <span class="cnote">活动必填</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input name="starttime" type="text" id="starttime" class="inputms" value="<?php echo GetDateTime(time()); ?>" readonly="readonly" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="endtime" type="text" id="endtime" class="inputms" value="<?php echo GetDateTime(time()); ?>" readonly="readonly" />
                            <script type="text/javascript">
                                date = new Date();
                                Calendar.setup({
                                    inputField: "endtime",
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="videourl" id="videourl" class="input" />
                    ...
                    <tr class="nb">
                        ...
                        <td>
                            <label><input type="radio" name="isgift" value="true" checked="checked" /> 是 &nbsp;</label>
                            <label><input type="radio" name="isgift" value="false" /> 否</label>
                            <span class="cnote">选择“否”, 活动结束后没有礼品领取环节</span>
                        </td>
                    </tr>
                    <tr>
            			<td height="35" align="right">活动分成比例(%)：</td>
            			<td><input name="commission_percent" type="text" id="commission_percent" class="input" />
                    ...
                    <tr class="nb">
                        ...
                        <td>
                            <label><input type="radio" name="islucky" value="true"  /> 是 &nbsp;</label>
                            <label><input type="radio" name="islucky" value="false" checked="checked" /> 否</label>
                            <span class="cnote">选择“否”, 活动结束后没有抽奖环节</span>
                        </td>
                    </tr>
                    <tr>
            			<td height="35" align="right">一等奖奖项：</td>
            			<td><input name="one_desc" type="text" id="one_desc" class="input" /></td>
            		</tr>
            		<tr>
            			<td height="35" align="right">一等奖数量：</td>
                        <td><input name="one_left" type="text" id="one_left" class="input"  /></td>
            		</tr>
            		<tr>
            			<td height="35" align="right">二等奖奖项：</td>
            			<td><input name="two_desc" type="text" id="two_desc" class="input" /></td>
            		</tr>
            		<tr>
            			<td height="35" align="right">二等奖数量：</td>
                        <td><input name="two_left" type="text" id="two_left" class="input"  /></td>
            		</tr>
            		<tr>
            			<td height="35" align="right">三等奖奖项：</td>
            			<td><input name="three_desc" type="text" id="three_desc" class="input" /></td>
            		</tr>
            		<tr>
            			<td height="35" align="right">三等奖数量：</td>
                        <td><input name="three_left" type="text" id="three_left" class="input"  /></td>
            		</tr>
                    <!-- 活动模块 -->
                    <tr class="nb">
                        <td colspan="2" height="26"><div class="line"> </div></td>

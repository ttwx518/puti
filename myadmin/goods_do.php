...
<div class="toolbarTab">
    ...
    <div id="search" class="search">
        ...
        <span class="b"><a href="javascript:;" onclick="GetSearch();"></a></span>
    </div>
    <div class="cl"></div>
</div>
...
//设置sql
    ...
    if (!empty($catgoryListPriv))
        $sql .= " AND classid IN ($catgoryListPriv)";

    if (!empty($cid))
        $sql .= " AND (classid=$cid OR parentstr Like '%,$cid,%')";

    if (!empty($tid))
        $sql .= " AND (typeid=$tid OR typepstr LIKE '%,$tid,%')";
    ...
    while ($row = $dosql->GetArray()) {
        ...
        <tr align="left" class="dataTr" onmouseover="this.className = 'dataTrOn'" onmouseout="this.className = 'dataTr'">
            ...
            <td><?php echo $salenum; ?></td>
            <td class="number"><?php echo GetDateTime($row['posttime']); ?></td>
            <td><?php echo $row['actualsales']; ?></td>
            <td class="action endCol">
                <span id="check<?php echo $row['id']; ?>"><?php echo $checkStr; ?></span> | 
                <span><?php echo $updateStr; ?></span> | 
...
<div class="bottomToolbar">
    <span class="selArea">
        ...
        <a href="javascript:;" onclick="AjaxClearAll();">删除</a>
    </span>
    <a href="goods_add.php" class="dataBtn">添加商品信息</a>
</div>
    ...
    <div class="quickToolbar">
        <div class="qiuckWarp">
            <div class="quickArea">
                ...
                <a href="goods_add.php" class="dataBtn">添加商品信息</a>
                <span class="pageSmall"><?php echo $dopage->AjaxPageSmall(); ?></span>
            </div>

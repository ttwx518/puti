        ...
        <form name="form" id="form" method="post" action="info_save.php">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                ...
                <tr>
                    ...
                    <td>
                        <select name="mainid" id="mainid" onchange="GetMainType(this.value)">
                            <option value="-1">请选择所属类别</option>
                            <?php GetAllType('#@__maintype', '#@__info', 'mainid'); ?>
                        </select>
                        <span class="maroon">*</span>
                        <span id="loading2" class="undis">数据读取中...</span>
                    </td>
                </tr>
                <?php
                }
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="picurl" id="picurl" class="input" value="<?php echo $picurl; ?>" />
                ...
                <tr class="nb">
                    ...
                    <td>
                        <input type="text" name="posttime" id="posttime" class="inputms" value="<?php echo $posttime; ?>" readonly="readonly" />
                        <script type="text/javascript">
                            Calendar.setup({
                                inputField: "posttime",

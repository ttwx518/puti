    ...
    <body>
                ...
                while ($row = $dosql->GetArray()) {
                    ...
                    <tr align="left" class="dataTr">
                        ...
                        <td class="action endCol">
                            <a href="userfavorite_save.php?action=del2&amp;id=<?php echo $row['id'] ?>" onclick="return ConfDel(0);">删除</a>
                        </td>
                    </tr>
                    <?php
                }
        ...
        <div class="bottomToolbar">
            <span class="selArea">
                ...
                <a href="javascript:DelAllNone('userfavorite_save.php');" onclick="return ConfDelAll(0);">删除</a>
            </span>
        </div>

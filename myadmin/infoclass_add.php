        ...
        <form name="form" id="form" method="post" action="infoclass_save.php" onsubmit="return cfm_infoclass();">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                <tr>
                    ...
                    <td width="380">
                        <select name="infotype" id="infotype">
                            <?php
                            //初始化类型
                            $infotype = isset($infotype) ? $infotype : '';//, '3' => '下载'
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="picwidth" id="picwidth" class="inputls" value="<?php echo GetCatpSize(0); ?>" /> 宽度(px)&nbsp;&nbsp;&nbsp;
                        <input type="text" name="picheight" id="picheight" class="inputls" value="<?php echo GetCatpSize(1); ?>" /> 高度(px)
                    </td>

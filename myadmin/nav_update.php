            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="maroon">*</span><span class="cnote">导航图片不为空，则以导航图片为优先级展示</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="relinkurl" id="relinkurl" class="input" value="<?php echo $row['relinkurl']; ?>" />
                        <span class="maroon">&nbsp;</span>
                        <span class="cnote">若开启URL静态化，系统自动切换至重写地址；请符合URL静态化设置的规则</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="target" id="target" class="inputs" value="<?php echo $row['target']; ?>" />
                ...
                <tr class="nb">
                    ...
                    <td>
                        <label><input type="radio" name="checkinfo" value="true" <?php if ($row['checkinfo'] == 'true') echo 'checked="checked"'; ?> /> 显示&nbsp;</label>
                        <label><input type="radio" name="checkinfo" value="false" <?php if ($row['checkinfo'] == 'false') echo 'checked="checked"'; ?> /> 隐藏</label>
                    </td>
                </tr>
            </table>

    ...
    <body>
        ...
        <form name="form" id="form" method="post" action="getmode_save.php?action=save">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
                ...
                <tr align="left" class="dataTr">
                    ...
                    <td align="center">
                        <a href="getmode_save.php?action=up&id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>" class="leftArrow" title="提升排序"></a>
                        <input type="text" name="orderid[]" id="orderid[]" class="inputls" value="<?php echo $row['orderid']; ?>" />
                        <a href="getmode_save.php?action=down&id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>" class="rightArrow" title="下降排序"></a>
                    </td>
                    <td class="action endCol">
                        <span><a href="getmode_save.php?action=check&id=<?php echo $row['id']; ?>&checkinfo=<?php echo $row['checkinfo']; ?>"><?php echo $checkinfo; ?></a></span> | 
                        <span class="nb"><a href="getmode_save.php?action=del2&id=<?php echo $row['id'] ?>" onclick="return ConfDel(0);">删除</a></span>
                    </td>
                </tr>
                <?php
                    }
        ...
        <div class="bottomToolbar">
            <span class="selArea">
                ...
                <a href="javascript:DelAllNone('getmode_save.php');" onclick="return ConfDelAll(0);">删除</a>
                <span>操作：</span>
                <a href="javascript:UpOrderID('getmode_save.php');">更新排序</a>
            </span>

...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <form name="form" id="form" method="post" action="diymenu_save.php" onsubmit="return cfm_diymenu();">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                ...
                <tr class="nb">
                    ...
                    <td>
                        <label><input type="radio" name="checkinfo" id="checkinfo" value="true" <?php if ($row['checkinfo'] == 'true') echo 'checked="checked"'; ?> /> 显示&nbsp;</label>
                        <label><input type="radio" name="checkinfo" id="checkinfo" value="false" <?php if ($row['checkinfo'] == 'false') echo 'checked="checked"'; ?> /> 隐藏</label>
                    </td>
                </tr>
                <tr class="nb">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" id="newline" class="formTable">
                <tr align="left" class="head">
                    <td width="80" height="36" class="firstCol">
                ...
                ?>
                <tr align="left">
                    <td width="80" height="40" class="firstCol">
                        <input type="checkbox" name="checkid[]" id="checkid[]" value="<?php echo $row['id']; ?>" />
                    </td>
                    <td align="left">
                        <input type="text" name="classnameupdate[]" id="classnameupdate[]" class="input" value="<?php echo $row['classname']; ?>" />
                        <input type="hidden" name="upid[]" id="upid[]" value="<?php echo $row['id']; ?>" />
                    </td>
                    <td align="left">
                        <input type="text" name="linkurlupdate[]" id="linkurlupdate[]" class="input" value="<?php echo $row['linkurl']; ?>" />
                    </td>
                    <td align="center">
                        <a href="diymenu_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=up&tid=<?php echo $id; ?>" class="leftArrow" title="提升排序"></a>
                        <input type="text" name="orderidupdate[]" id="orderidupdate[]" class="inputls" value="<?php echo $row['orderid']; ?>" />
                        <a href="diymenu_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=down&tid=<?php echo $id; ?>" class="rightArrow" title="下降排序"></a>
                    </td>
        ...
        <div class="bottomToolbar">
            ...
            <a href="#" onclick="UpdateForm('diymenu_save.php');" class="dataBtn">更新全部</a>
            <a href="diymenu.php" class="dataBack">返回列表</a>
        </div>
    </body>
</html>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
            ...
            <tr align="left" class="dataTr">
                <td height="36" class="firstCol">佣金排行统计</td>
                <td><?php echo $dosql->GetTableRow('#@__commission_record'); ?></td>
                <td class="number endCol"><?php echo GetLastEventTime('commission_record'); ?></td>
            </tr>
            <!--
            <tr align="left" class="dataTr">
            ...
            <tr align="left" class="dataTr">
                <td height="36" class="firstCol">积分规则管理</td>
                <td><?php echo $dosql->GetTableRow('#@__integralrule'); ?></td>
                <td class="number endCol"><?php echo GetLastEventTime('integralrule'); ?></td>
            </tr>
            -->
            <tr align="left" class="dataTr">

        ...
        <form name="form" id="form" method="post" action="nav_save.php" onsubmit="return cfm_nav();">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="classname" id="classname" class="input" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="relinkurl" id="relinkurl" class="input" />
                        <span class="maroon">&nbsp;</span>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="target" id="target" class="inputs" value="" />
                ...
                <tr class="nb">
                    ...
                    <td>
                        <label><input type="radio" name="checkinfo" value="true" checked="checked"  /> 显示&nbsp;</label>
                        <label><input type="radio" name="checkinfo" value="false" /> 隐藏</label>
                    </td>
                </tr>
            </table>

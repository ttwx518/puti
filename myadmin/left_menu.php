...
<!--                             <a href="infoimg.php" target="main">图片信息管理</a> -->
                            <a href="apply.php" target="main">活动申请管理</a>
                            <a href="message.php" target="main">爱心留言管理</a>
                            <a href="comment.php" target="main">商品评价管理</a>
                            <div class="hr_1"> </div>
                            <a href="lottery.php" target="main">中奖管理</a>
<!--                             <a href="lottery_set.php" target="main">中奖设置</a> -->
                            <!--
                            ...
                            <a href="infoflag.php" target="main" class="infoattr">信息标记管理</a>
                            <a href="infosrc.php" target="main" class="infosrc">信息来源管理</a>
                            -->
                        </div>
                    </div>
                    <div class="hr_5"></div>
...
<!--                             <a href="commissionRanking.php" target="main">佣金排行统计</a> -->
                            ...
                            <a href="integralrule.php" target="main">积分规则管理</a>
                            -->
...
<!--                             <a href="cascade.php" target="main">级联数据管理</a> -->
                            <!--
                            <a href="adtype.php" target="main" class="adtype">广告位管理</a>
                            <a href="weblinktype.php" target="main" class="weblinktype">友情链接类别</a>
                            -->
                        </div>
                    </div>
                    <div class="hr_5"></div>
                    <div class="menubox">
                        ...
                        <div id="leftmenu04" style="display:none">
                            ...
                            <a href="goodsflag.php" target="main" class="goodsinfoattr">商品信息属性管理</a>
                            -->
                            <div class="hr_1"> </div>

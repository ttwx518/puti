...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="topToolbar">
            ...
            <span class="text"><a href="admanage.php">广告管理</a></span>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
                            <tr align="left" class="dataTr">
                                ...
                                <td width="15%" align="center">
                                    <a href="adtype_save.php?action=up&id=<?php echo $row['id']; ?>&parentid=<?php echo $row['parentid']; ?>&orderid=<?php echo $row['orderid']; ?>" class="leftArrow" title="提升排序"></a>
                                    <input name="orderid[]" type="text" id="orderid[]" class="inputls" value="<?php echo $row['orderid']; ?>" />
                                    <a href="adtype_save.php?action=down&id=<?php echo $row['id']; ?>&parentid=<?php echo $row['parentid']; ?>&orderid=<?php echo $row['orderid']; ?>" class="rightArrow" title="下降排序"></a>
                                </td>
                                <td width="30%" class="action endCol">
                                    <span><a href="adtype_add.php?id=<?php echo $row['id']; ?>">添加广告位</a></span> | 
                                    <span><a href="adtype_save.php?action=check&id=<?php echo $row['id']; ?>&checkinfo=<?php echo $row['checkinfo']; ?>" title="点击进行显示与隐藏操作"><?php echo $checkinfo; ?></a></span> | 
                                    <span><a href="adtype_update.php?id=<?php echo $row['id']; ?>">修改</a></span> | 
                                    <span class="nb"><a href="adtype_save.php?action=del&id=<?php echo $row['id'] ?>" onclick="return ConfDel(2);">删除</a></span>
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <div class="bottomToolbar">
            <span class="selArea">
                ...
                <a href="javascript:DelAll('adtype_save.php');" onclick="return ConfDelAll(1);">删除</a>
                <span>操作：</span>
                <a href="javascript:UpOrderID('adtype_save.php');">排序</a> - 
                <a href="javascript:ShowAllRows();">展开</a> - 
                <a href="javascript:HideAllRows();">隐藏</a>
            </span>
            <a href="adtype_add.php" class="dataBtn">添加广告位</a>
        </div>
        <div class="page">

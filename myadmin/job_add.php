        ...
        <form name="form" id="form" method="post" action="job_save.php" onsubmit="return cfm_job();">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                <tr>
                    ...
                    <td width="75%">
                        <input type="text" name="title" id="title" class="input" onblur="checkuser()" />
                ...
                <tr>
                    ...
                    <td>
                        <label><input type="radio" name="jobsex" value="0" checked="checked" /> 不限&nbsp;</label>
                        <label><input type="radio" name="jobsex" value="1" /> 男&nbsp;</label>
                        <label><input type="radio" name="jobsex" value="2" /> 女</label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="workdesc" id="workdesc"></textarea>
                        <script>
                            var editor;

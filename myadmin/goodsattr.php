...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="topToolbar">
            <span class="title">商品属性管理</span>
            <span class="text">当前分类：<a href="goodstype.php" title="点击返回商品分类"><?php echo $classname; ?></a></span>
        ...
        <form name="form" id="form" method="post" action="goodsattr_save.php?action=save">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
                ...
                <tr align="left" class="dataTr">
                    ...
                    <td align="center">
                        <a href="goodsattr_save.php?gid=<?php echo $gid; ?>&id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=up" class="leftArrow" title="提升排序"></a>
                        <input name="orderid[]" type="text" id="orderid[]" class="inputls" value="<?php echo $row['orderid']; ?>" />
                        <a href="goodsattr_save.php?gid=<?php echo $gid; ?>&id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=down" class="rightArrow" title="下降排序"></a>
                    </td>
                    <td class="action endCol">
                        <span><a href="goodsattr_save.php?action=check&gid=<?php echo $gid; ?>&id=<?php echo $row['id']; ?>&checkinfo=<?php echo $row['checkinfo']; ?>" title="点击进行显示与隐藏操作"><?php echo $checkinfo; ?></a></span> | 
                        <span class="nb"><a href="goodsattr_save.php?action=del2&gid=<?php echo $gid; ?>&id=<?php echo $row['id'] ?>" onclick="return ConfDel(0);">删除</a></span>
                    </td>
                </tr>
                <?php
                        }
                ...
                <tr align="left" class="dataTrOn">
                    ...
                    <td class="endCol">
                        ...
                        <input type="radio" name="checkinfoadd" value="false" /> 隐藏</label>
                    </td>
                </tr>
            </table>
        </form>
        <div class="bottomToolbar">
            <span class="selArea">
                ...
                <a href="javascript:DelAllNone('goodsattr_save.php');" onclick="return ConfDelAll(0);">删除</a>
                <span>操作：</span>
                <a href="javascript:UpOrderID('goodsattr_save.php');">更新排序</a>
            </span>

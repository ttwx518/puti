        ...
        <form name="form" id="form" method="post" action="goods_save.php" onsubmit="return cfm_goods();">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                ...
                <tr style="display: none">
                    ...
                    <td>
                        <label><input type="radio" name="payfreight" value="0" />买家承担&nbsp;</label>
                        <label><input type="radio" name="payfreight" value="1" checked="checked" />卖家承担</label>
                    </td>
                </tr>
                <tr style="display: none">
                    <td width="25%" height="40" align="right">商品运费：</td>
                    <td>
                        <input name="freight" type="text" id="freight" class="inputs" style="width:100px" /> 元
                    </td>
                </tr>
                <tr>
                    <td height="40" align="right">商品价格：</td>
                    <td>
                        普通销售价 <input name="salesprice" type="text" id="salesprice" class="inputs" style="width:50px" />&nbsp;&nbsp;
                        大使销售价 <input name="salesprice_dashi" type="text" id="salesprice_dashi" class="inputs" style="width:50px" />&nbsp;&nbsp;
                ...
                <tr style="display: none">
                    ...
                    <td>
                        货主奖励佣金 <input name="directCommission" type="text" id="directCommission" class="inputs" style="width:50px" />&nbsp;&nbsp;
                        平台奖励佣金 
                        <?php
                        $dosql->Execute("SELECT * FROM `#@__usergroup` ORDER BY dqa ASC");
                        while ($row = $dosql->GetArray()) {
                            echo $row['groupname'].' <input name="indirectCommission['.$row['id'].']" type="text" class="inputs" value="'.$row['commission'].'" style="width:50px" />&nbsp;&nbsp;';
                        }
                        ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input name="weight" type="text" class="input" id="weight" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input name="housenum" type="text" id="housenum" class="input" value="" /></td>
                </tr>

                <tr>
                    <td height="40" align="right">实际销量：</td>
                    <td><input name="actualsales" type="text" id="actualsales" class="input" value="" /></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="description" id="description" class="textdesc"></textarea>
                        <div class="hr_5"> </div>
                ...
                <tr>
                    ...
                    <td><input type="text" name="salenum" id="salenum" class="inputos" value="0" /></td>
                </tr>

                <tr>
                    <td height="40" align="right">购物数量：</td>
                    <td>
                        <input type="text" name="ordernums" id="ordernums" class="inputos" value="5" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input name="starttime" type="text" id="starttime" class="inputms" value="" />
                        <script type="text/javascript">
                            date = new Date();
                            Calendar.setup({
                ...
                <tr>
                    ...
                    <td>
                        <input name="endtime" type="text" id="endtime" class="inputms" value="" />
                        <script type="text/javascript">
                            date = new Date();
                            Calendar.setup({
                                inputField: "endtime",

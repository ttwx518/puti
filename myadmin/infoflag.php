    ...
    <body>
        ...
        <form name="form" id="form" method="post" action="infoflag_save.php?action=save">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
                ...
                <tr align="left" class="dataTr">
                    ...
                    <td align="center">
                        <a href="infoflag_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=up" class="leftArrow" title="提升排序"></a>
                    ...
                    <td class="action endCol">
                        <a href="infoflag_save.php?action=del2&id=<?php echo $row['id'] ?>" onclick="return ConfDel(0);">删除</a>
                    </td>
                </tr>
                <?php
                    }
        ...
        <div class="bottomToolbar">
            <span class="selArea">
                ...
                <a href="javascript:DelAllNone('infoflag_save.php');" onclick="return ConfDelAll(0);">删除</a>
                <span>操作：</span>
                <a href="javascript:UpOrderID('infoflag_save.php');">更新排序</a>
            </span>

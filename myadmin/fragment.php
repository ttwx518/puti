...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
            ...
            <tr align="left" class="dataTr">
                ...
                <td class="action endCol">
                    <span><a href="fragment_update.php?id=<?php echo $row['id']; ?>">修改</a></span> | 
                    <span class="nb"><a href="fragment_save.php?action=del2&id=<?php echo $row['id']; ?>">删除</a></span>
                </td>
            </tr>
            <?php
            }
        ...
        <div class="quickToolbar">
            <div class="qiuckWarp">
                <div class="quickArea">
                    <a href="fragment_add.php" class="dataBtn">添加碎片数据</a>

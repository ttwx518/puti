    ...
    <body>
                ...
                if ($dosql->GetTotalRow() > 0) {
                    while ($row = $dosql->GetArray()) {
                        ...
                        <tr align="left" class="dataTr">
                            ...
                            <td>
                                <input type="text" name="flagname[]" id="flagname[]" class="inputd" value="<?php echo $row['flagname']; ?>" />
                                <input type="hidden" name="id[]" id="id[]" value="<?php echo $row['id']; ?>" />
                            </td>
                            <td><input type="text" name="flag[]" id="flag[]" class="inputd" value="<?php echo $row['flag']; ?>" /></td>
                            <td align="center">
                                <a href="goodsflag_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=up" class="leftArrow" title="提升排序"></a>
                                <input type="text" name="orderid[]" id="orderid[]" class="inputls" value="<?php echo $row['orderid']; ?>" />
                                <a href="goodsflag_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=down" class="rightArrow" title="下降排序"></a>
                            </td>
        ...
        <div class="bottomToolbar">
            <span class="selArea">
                ...
                <a href="javascript:DelAllNone('goodsflag_save.php');" onclick="return ConfDelAll(0);">删除</a>
                <span>操作：</span>
                <a href="javascript:UpOrderID('goodsflag_save.php');">更新排序</a>
            </span>

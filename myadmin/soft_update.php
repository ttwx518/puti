            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                ...
                <tr class="nb">
                    <td colspan="2" height="0" id="df">
                        <?php echo GetDiyField('3', $row['classid'], $row); ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="softsize" id="softsize" class="input" value="<?php echo $row['softsize']; ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="dlurl" id="dlurl" class="input" value="<?php echo $row['dlurl']; ?>" />
                        <span class="cnote"><span class="grayBtn" onclick="GetUploadify('uploadify', '软件上传', 'soft', 'soft', 1,<?php echo $cfg_max_file_size; ?>0, 'dlurl')">上 传</span> </span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="keywords" type="text" id="keywords" class="input" value="<?php echo $row['keywords']; ?>" />

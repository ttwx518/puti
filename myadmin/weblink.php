...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="topToolbar">
            <span class="title">友情链接管理</span> <span class="alltype">
                <?php
                if (isset($tid)) {
            ...
            <span class="text"><a href="weblinktype.php">类别管理</a></span>
                ...
                while ($row = $dosql->GetArray()) {
                    ...
                    <tr align="left" class="dataTr">
                        ...
                        <td class="action endCol">
                            <span><a href="weblink_save.php?id=<?php echo $row['id']; ?>&action=check&checkinfo=<?php echo $row['checkinfo']; ?>" title="点击进行审核与未审操作"><?php echo $checkinfo; ?></a></span> | 
                            <span><a href="weblink_update.php?id=<?php echo $row['id']; ?>">修改</a></span> | 
                            <span class="nb"><a href="weblink_save.php?action=del2&id=<?php echo $row['id'] ?>" onclick="return ConfDel(2);">删除</a></span>
                        </td>
                    </tr>
                    <?php
                }
        ...
        <div class="bottomToolbar">
            <span class="selArea">
                ...
                <a href="javascript:DelAll('weblink_save.php');" onclick="return ConfDel(0);">删除</a>
            </span>
            <a href="weblink_add.php" class="dataBtn">添加友情链接</a>
        </div>

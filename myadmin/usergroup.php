    ...
    <body>
        ...
        <form name="form" id="form" method="post" action="usergroup_save.php?action=save">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
                <tr align="left" class="head">
                    ...
                    <td width="20%">用户组分销商数量</td>
                    <td width="15%">星星数</td>
                    <td width="10%">平台奖励佣金</td>
                ...
                <tr align="left" class="dataTr">
                    ...
                    <td>
                        <input type="text" name="dqa[]" id="dqa[]" class="inputls" value="<?php echo $row['dqa']; ?>" />
                        ~
                        <input type="text" name="dqb[]" id="dqb[]" class="inputls" value="<?php echo $row['dqb']; ?>" />
                    </td>
                    <td><input type="text" name="stars[]" id="stars[]" class="inputls" value="<?php echo $row['stars']; ?>" /></td>
                    <td><input type="text" name="commission[]" id="commission[]" class="inputs" value="<?php echo $row['commission']; ?>" /></td>
                    <td class="action endCol">
                        <!--<a href="usergroup_save.php?action=del2&id=<?php echo $row['id'] ?>" onclick="return ConfDel(0);">删除</a>-->
                    </td>
                </tr>
                <?php
                    }
                ...
                <tr align="left" class="dataTrOn">
                    ...
                    <td>
                        <input type="text" name="dqa_add" id="dqa_add" class="inputls" value="" />
                        ~
                        <input type="text" name="dqb_add" id="dqb_add" class="inputls" value="" />
                    </td>
                    <td><input type="text" name="stars_add" id="stars_add" class="inputls" /></td>
                    <td><input type="text" name="commission_add" id="commission_add" class="inputs" /></td>
                    <td>&nbsp;</td>
                </tr>
                -->
            </table>
        ...
        <div class="bottomToolbar">
            <span class="selArea">
                ...
                <!--<a href="javascript:DelAllNone('usergroup_save.php');" onclick="return ConfDelAll(0);">删除</a>-->
            </span>

    ...
    <body>
        ...
        <form name="form" id="form" method="post" action="postmode_save.php?action=save">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
                ...
                <tr align="left" class="dataTr">
                    ...
                    <td align="left"><input type="text" name="postcode[]" id="postcode[]" class="inputd" value="<?php echo $row['postcode']; ?>" /></td>
                    <td><input type="text" name="postprice[]" id="postprice[]" class="inputls" value="<?php echo $row['postprice']; ?>" /></td>
                    <td align="center">
                        <a href="postmode_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=up" class="leftArrow" title="提升排序"></a>
                        <input type="text" name="orderid[]" id="orderid[]" class="inputls" value="<?php echo $row['orderid']; ?>" />
                        <a href="postmode_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=down" class="rightArrow" title="下降排序"></a>
                    </td>
                    <td class="action endCol">
                        <span><a href="postmode_save.php?id=<?php echo $row['id']; ?>&action=check&checkinfo=<?php echo $row['checkinfo']; ?>" title="点击进行显示与隐藏操作"><?php echo $checkinfo; ?></a></span> | 
                        <span class="nb"><a href="postmode_save.php?action=del2&id=<?php echo $row['id'] ?>" onclick="return ConfDel(0);">删除</a></span>
                    </td>
                </tr>
                <?php
                    }
                ...
                <tr align="left" class="dataTrOn">
                    ...
                    <td><input type="text" name="postcodeadd" id="postcodeadd" class="input" /></td>
                    ...
                    <td class="endCol">
                        <label><input type="radio" name="checkinfoadd" value="true" checked="checked" /> 显示&nbsp;</label>
                        <label><input type="radio" name="checkinfoadd" value="false" /> 隐藏</label>
                    </td>
                </tr>
            </table>
        </form>
        <div class="bottomToolbar">
            <span class="selArea">
                ...
                <a href="javascript:DelAllNone('postmode_save.php');" onclick="return ConfDelAll(0);">删除</a>
                <span>操作：</span>
                <a href="javascript:UpOrderID('postmode_save.php');">更新排序</a>
            </span>

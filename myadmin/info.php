...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
            ...
            //循环单页
            $dopage->GetPage("SELECT * FROM `#@__infoclass` WHERE `siteid`='$cfg_siteid' AND `infotype`=0", $cfg_pagenum, 'id ASC');
            while ($row = $dosql->GetArray()) {
                //如果超级管理员直接显示
                if ($cfg_adminlevel != 1) {
        ...
        <div class="quickToolbar">
            <div class="qiuckWarp">
                <div class="quickArea">
                    <a href="infoclass.php" class="dataBtn">返回栏目管理</a>

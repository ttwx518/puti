        ...
        <form name="form" id="form" method="post" action="infoclass_save.php" onsubmit="return cfm_infoclass();">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                <tr>
                    ...
                    <td width="380">
                        <select name="infotype" id="infotype">
                            <?php //, '3' => '下载'
                            foreach (array('0' => '单页', '1' => '列表', '2' => '图片', '4' => '商品') as $k => $v) {
                                if ($row['infotype'] == $k)
                    ...
                    <td><span class="cnote">带<span class="maroon">*</span>号表示为必填项</span>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="picwidth" id="picwidth" class="inputls" value="<?php echo $row['picwidth']; ?>" /> 宽度(px)&nbsp;&nbsp;&nbsp;
                        <input type="text" name="picheight" id="picheight" class="inputls" value="<?php echo $row['picheight']; ?>" /> 高度(px)
                    </td>

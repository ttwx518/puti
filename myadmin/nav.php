                    ...
                    <div rel="rowpid_<?php echo GetTopID($row['parentstr']); ?>">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
                            <tr align="left" class="dataTr">
                                <td width="5%" height="36" class="firstCol">
                                    <input type="checkbox" name="checkid[]" value="<?php echo $row['id']; ?>" />
                                </td>
                                <td width="3%">
                                    <?php echo $row['id']; ?>
                                ...
                                <td width="15%" align="center">
                                    <a href="nav_save.php?action=up&id=<?php echo $row['id']; ?>&parentid=<?php echo $row['parentid']; ?>&orderid=<?php echo $row['orderid']; ?>" class="leftArrow" title="提升排序"></a>
                                    <input type="text" name="orderid[]" id="orderid[]" class="inputls" value="<?php echo $row['orderid']; ?>" />
                                    <a href="nav_save.php?action=down&id=<?php echo $row['id']; ?>&parentid=<?php echo $row['parentid']; ?>&orderid=<?php echo $row['orderid']; ?>" class="rightArrow" title="下降排序"></a>
                                </td>
            ...
            <div class="qiuckWarp">
                <div class="quickArea">
                    <span class="selArea">
                        ...
                        <a href="javascript:DelAll('nav_save.php');" onclick="return ConfDelAll(1);">删除</a>
                        <span>操作：</span>
                        <a href="javascript:UpOrderID('nav_save.php');">排序</a> - 
                        <a href="javascript:ShowAllRows();">展开</a> - 
                        <a href="javascript:HideAllRows();">隐藏</a>
                    </span>
                    <a href="nav_add.php" class="dataBtn">添加导航菜单</a>

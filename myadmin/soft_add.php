        ...
        <form name="form" id="form" method="post" action="soft_save.php" onsubmit="return cfm_infolm();">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="softsize" id="softsize" class="input" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="dlurl" id="dlurl" class="input" />
                        <span class="cnote">
                            <span class="grayBtn" onclick="GetUploadify('uploadify', '软件上传', 'soft', 'soft', 1,<?php echo $cfg_max_file_size; ?>0, 'dlurl')">上 传</span>
                        </span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="editToolbar">
                            ...
                            <label><input type="text" name="autodescsize" id="autodescsize" class="inputls" value="200" size="3" /> 字到摘要&nbsp;</label>
                            <label><input type="checkbox" name="autopage" id="autopage" value="true" /> 自动分页</label>
                            <input type="text" name="autopagesize" id="autopagesize" class="inputls" value="5" size="6" /> KB
                        </div>
                    </td>
                </tr>
                <tr class="nb">

...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="topToolbar">
            ...
            <span class="text">[<a href="upload_filemgr_clear.php" class="clearFile">清理未使用文件</a>]</span>
                ...
                while ($row = $dosql->GetArray()) {
                    ...
                    <tr align="left" class="dataTr">
                        <td height="36" class="firstCol">
                            <input type="checkbox" name="checkid[]" id="checkid[]" value="<?php echo $row['path']; ?>" />
                        </td>
            ...
            <div class="qiuckWarp">
                <div class="quickArea">
                    <span class="selArea">
                        ...
                        <a href="javascript:DelAll('upload_filemgr_save.php','&mode=sql');" onclick="return ConfDelAll(0);">删除</a>
                    </span>

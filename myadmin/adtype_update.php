        ...
        <form name="form" id="form" method="post" action="adtype_save.php" onsubmit="return cfm_adtype();">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                ...
                <tr>
                    ...
                    <td>
                        <input name="classname" type="text" id="classname" class="input" value="<?php echo $row['classname']; ?>" />
                        <span class="maroon">*</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" name="width" id="width" class="inputls" value="<?php echo $row['width']; ?>" /> 宽度(px)&nbsp;&nbsp;
                        <input type="text" name="height" id="height" class="inputls" value="<?php echo $row['height']; ?>" /> 高度(px)
                    </td>
                </tr>
                <tr>

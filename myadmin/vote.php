    ...
    <body>
                ...
                <tr align="left" class="dataTr">
                    ...
                    <td class="number">
                        ...
                        if (empty($row['starttime'])) {
                            ...
                            echo GetDateTime($row['starttime']);
                        }
                        ?>
                    </td>
                    <td class="number">
                    ...
                    <td class="action endCol">
                        <span><a href="../vote.php?id=<?php echo $row['id']; ?>" target="_blank" title="查看投票结果">预览</a></span> | 
                        <span><a href="vote_update.php?id=<?php echo $row['id']; ?>">修改</a></span> | 
                        <span class="nb"><a href="vote_save.php?action=delvote&id=<?php echo $row['id'] ?>" onclick="return ConfDel(0);">删除</a></span>
                    </td>
                </tr>
                <?php
                }
        ...
        <div class="bottomToolbar">
            <span class="selArea">
                ...
                <a href="javascript:DelAllNone('vote_save.php');" onclick="return ConfDelAll(0);">删除</a>
            </span>
            <a href="vote_add.php" class="dataBtn">添加投票信息</a>
        </div>

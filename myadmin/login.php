...
<html>
    ...
    <body class="loginBody">
        <div class="loginTop" <?php echo GetLoginBg(); ?>>
            <!--<div class="logo"><a href="javascript:;" target="_blank"></a></div>-->
            <div class="text">
                <span class="note">
        ...
        <div class="loginWarp">
            <div class="loginArea">
                ...
                <div class="loginForm">
                    ...
                    <!--<div class="loginThanks">感谢您使用<span>weixin66</span>产品</div>-->
                </div>
            </div>
        </div>
        <div class="loginCopyright">© 2014 www.weixin66.net</div>
    </body>
</html>
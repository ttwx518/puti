        ...
        <form name="form" id="form" method="post" action="admin_save.php" onsubmit="return cfm_upadmin();">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" name="oldpwd" id="oldpwd" class="input" maxlength="16" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" name="password" id="password" class="input" maxlength="16" />
                        <span class="maroon">*</span><span class="cnote">6-16个字符组成，区分大小写</span>
                    </td>
                </tr>
                <tr>
                    <td height="40" align="right">确　认：</td>
                    <td>
                        <input type="password"  name="repassword" id="repassword" class="input" maxlength="16" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text"  name="nickname" id="nickname" class="input" value="<?php echo $row['nickname']; ?>" />
                        <span class="maroon">&nbsp;</span><span class="cnote">用于文章作者的显示</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <label><input type="radio" name="checkadmin" value="true" <?php if ($row['checkadmin'] == 'true') echo 'checked="checked"'; ?> /> 已审核&nbsp;</label>
                        <label><input type="radio" name="checkadmin" value="false" <?php if ($row['checkadmin'] == 'false') echo 'checked="checked"'; ?> /> 未审核</label>
                    </td>
                </tr>
                <tr>

        ...
        <form name="form" id="form" method="post" action="vote_save.php" onsubmit="return cfm_vote();">
                ...
                <tr>
                    <td width="25%" height="40" align="right"><?php if ($i == 0) { ?>
                        ...
                        <?php
                            ...
                            echo '<span class="delVoteTxt"><a href="vote_save.php?id=' . $id . '&action=delopt&option_id=' . $row2['id'] . '">删</a></span>：';
                        }
                        ?></td>
                    <td width="75%">
                        <input type="text" name="options[]" id="options[]" class="input" value="<?php echo $row2['options']; ?>" />
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                <tr>
                    ...
                    <td width="75%">
                        <input type="text" name="starttime" id="starttime" class="inputms" value="<?php echo GetDateTime($row['starttime']); ?>" readonly="readonly" />
                        <script type="text/javascript">
                            Calendar.setup({
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="endtime" id="endtime" class="inputms" value="<?php echo GetDateTime($row['endtime']); ?>" readonly="readonly" />
                        <script type="text/javascript">
                            Calendar.setup({
                                inputField: "endtime",
                                ifFormat: "%Y-%m-%d %H:%M:%S",
                ...
                <tr>
                    ...
                    <td>
                        <label><input type="radio" name="isguest" value="true" <?php if ($row['isguest'] == 'true') echo 'checked="checked"'; ?> /> 允许&nbsp;</label>
                        <label><input type="radio" name="isguest" value="false" <?php if ($row['isguest'] == 'false') echo 'checked="checked"'; ?> /> 不允许</label>
                    </td>
                </tr>
                <tr>
                    <td height="40" align="right">查看投票：</td>
                    <td>
                        <label><input type="radio" name="isview" value="true" <?php if ($row['isview'] == 'true') echo 'checked="checked"'; ?> /> 允许&nbsp;</label>
                        <label><input type="radio" name="isview" value="false" <?php if ($row['isview'] == 'false') echo 'checked="checked"'; ?> /> 不允许</label>
                    </td>
                </tr>
                <tr>
                    <td height="40" align="right">投票间隔：</td>
                    <td>
                        <input type="text" name="intval" id="intval" class="input" value="<?php echo $row['intval']; ?>" />
                ...
                <tr class="nb">
                    ...
                    <td>
                        <label><input type="radio" name="isradio" value="1" <?php if ($row['isradio'] == '1') echo 'checked="checked"'; ?> /> 单选&nbsp;</label>
                        <label><input type="radio" name="isradio" value="2" <?php if ($row['isradio'] == '2') echo 'checked="checked"'; ?> /> 多选</label>
                    </td>
                </tr>
                <tr class="nb">

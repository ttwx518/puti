        ...
        <form name="form" id="form" method="post" action="job_save.php" onsubmit="return cfm_job();">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                ...
                <tr>
                    ...
                    <td>
                        <label><input type="radio" name="jobsex" value="0" <?php if ($row['jobsex'] == '0') echo 'checked="checked"'; ?> /> 不限&nbsp;</label>
                        <label><input type="radio" name="jobsex" value="1" <?php if ($row['jobsex'] == '1') echo 'checked="checked"'; ?> /> 男&nbsp;</label>
                        <label><input type="radio" name="jobsex" value="2" <?php if ($row['jobsex'] == '2') echo 'checked="checked"'; ?> /> 女</label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="workdesc" id="workdesc"><?php echo $row['workdesc']; ?></textarea>
                        <script>
                            var editor;

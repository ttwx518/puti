        ...
        <form name="form" id="form" method="post" action="weblink_save.php" onsubmit="return cfm_weblink();">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="webname" id="webname" class="input" value="<?php echo $row['webname']; ?>" />
                ...
                <tr class="nb">
                    ...
                    <td>
                        <label><input type="radio" name="checkinfo" value="true" <?php
                        if ($row['checkinfo'] == 'true') {
                            echo 'checked="checked"';
                        }
                        ?> />
                        是 &nbsp;</label>
                        <label><input type="radio" name="checkinfo" value="false" <?php
                        if ($row['checkinfo'] == 'false') {
                            echo 'checked="checked"';
                        }
                        ?> />
                        否</label>

        ...
        <form name="form" id="form" method="post" action="infolist_save.php" onsubmit="return cfm_infolm();">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="titlePanel">
                            ...
                            <span onclick="colorpicker('colorpanel', 'colorval', 'title');" class="color" title="标题颜色"> </span> <span id="colorpanel"></span> <span onclick="blodpicker('boldval', 'title');" class="blod" title="标题加粗"> </span> <span onclick="clearpicker()" class="clear" title="清除属性">[#]</span> &nbsp; 
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="description" id="description" class="textdesc"><?php echo $row['description']; ?></textarea>
                        <div class="hr_5"></div>
                ...
                <!-- 活动模块 -->
                <tr>
                        <td height="40" align="right">活动举办者ID：</td>
                        <td>
                            <input type="text" name="auid" id="auid" class="input" value="<?php echo $row['auid']?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="goodsprice" id="goodsprice" value="<?php echo $row['goodsprice']?>" class="input" />
                        <span class="cnote">活动必填</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="housenum" id="housenum" value="<?php echo $row['housenum']?>" class="input" />
                        <span class="cnote">活动必填</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="goodsunit" id="goodsunit"  value="<?php echo $row["goodsunit"]?>" class="input" />
                        <span class="cnote">活动必填</span>
                    </td>
                </tr>
                <tr>
                    <td height="40" align="right">认购商品名称：</td>
                    <td>
                        <input type="text" name="goodstitle" id="goodstitle" value="<?php echo $row['goodstitle']?>"  class="input" />
                        <span class="cnote">活动必填</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input name="starttime" type="text" id="starttime" class="inputms"  value="<?php echo GetDateTime($row['starttime'])?>" value="<?php echo GetDateTime(time()); ?>" readonly="readonly" />
                ...
                <tr>
                    ...
                    <td>
                        <input name="endtime" type="text" id="endtime" class="inputms"  value="<?php echo GetDateTime($row['endtime'])?>" value="<?php echo GetDateTime(time()); ?>" readonly="readonly" />
                        <script type="text/javascript">
                            date = new Date();
                            Calendar.setup({
                                inputField: "endtime",
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="videourl" id="videourl"  value="<?php echo $row['videourl']?>" class="input" />
                        <span class="cnote">活动结束后播放</span>
                    </td>
                </tr>
                <tr class="nb" style="display: none;">
                    <td height="40" align="right">是否有小礼品：</td>
                    <td>
                        <label><input type="radio" name="isgift" value="true" <?php if ($row['isgift'] == 'true') echo 'checked="checked"'; ?> /> 是 &nbsp;</label>
                        <label><input type="radio" name="isgift" value="false" <?php if ($row['isgift'] == 'false') echo 'checked="checked"'; ?> /> 否</label>
                        <span class="cnote">选择“否”, 活动结束后没有礼品领取环节</span>
                    </td>
                </tr>
                <tr>
        			<td height="35" align="right">活动分成比例(%)：</td>
        			<td><input name="commission_percent" type="text" id="commission_percent" class="input" value="<?php echo $row['commission_percent']?>" />
                ...
                <tr class="nb">
                    ...
                    <td>
                        <label><?php echo $cfg_weburl.'index.php?c=info&a=activitylist&clsid='.$row['id'];?></label>
                    </td>
                </tr>
                <?php endif;?>
            </table>

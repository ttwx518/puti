...
IsModelPriv('upload_filemgr_sql');
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="topToolbar">
            ...
            <span class="text">[当前目录：<strong>/<?php echo $dirname; ?></strong><span>|</span><a href="<?php echo $dirhigh; ?>" class="topFolder"><?php echo $dirtext; ?></a><span>|</span><a href="upload_filemgr_clear.php" class="clearFile">清理未使用文件</a>]</span>
        ...
        <form name="form" id="form" method="post" action="upload_filemgr_save.php">
            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" class="dataTable">
                ...
                while (($filename = readdir($handler)) !== false) {
                    ...
                    if ($filename != '.' && $filename != '..' && $filename != ($dirname == 'uploads/' ? 'index.htm' : '')) {
                        ...
                        ?>
                            <tr align="left" class="dataTr">
                                <td height="36" class="firstCol">
                                    <input type="checkbox" name="checkid[]" id="checkid[]" value="<?php echo $gbfilename; ?>" disabled="disabled" />
                                </td>
                                ...
                                <td class="action endCol">
                                    <span><a href="upload_filemgr_dir.php?dirname=<?php echo urlencode($dirname . $gbfilename . '/'); ?>">进入</a></span> | 
                                    <span class="nb">
                                    <?php
                                    if ($dirname == 'uploads/') {
                                        echo '删除';
                                    ...
                                    ?>
                                    <a href="upload_filemgr_save.php?mode=dir&action=deldir&dirname=<?php echo urlencode($dirname); ?>&filename=<?php echo urlencode($filename . '/'); ?>" onclick="return ConfDel(0);">删除</a>
                                    <?php } ?>
                                    </span>
                                </td>
                            </tr>
            ...
            <div class="qiuckWarp">
                <div class="quickArea">
                    <span class="selArea">
                        ...
                        <a href="javascript:DelAll('upload_filemgr_save.php','&mode=dir');" onclick="return ConfDelAll(0);">删除</a>
                    </span>

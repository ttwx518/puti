    ...
    <body>
        ...
        <form name="form" id="form" method="post" action="paymode_save.php?action=save">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
                ...
                <tr align="left" class="dataTr">
                    ...
                    <td align="left"><input type="text" name="paycode[]" id="paycode[]" class="inputd" value="<?php echo $row['paycode']; ?>" /></td>
                    <td align="center">
                        <a href="paymode_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=up" class="leftArrow" title="提升排序"></a>
                        <input type="text" name="orderid[]" id="orderid[]" class="inputls" value="<?php echo $row['orderid']; ?>" />
                        <a href="paymode_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=down" class="rightArrow" title="下降排序"></a>
                    </td>
                    <td class="action endCol">
                        <span><a href="paymode_save.php?id=<?php echo $row['id']; ?>&action=check&checkinfo=<?php echo $row['checkinfo']; ?>"><?php echo $checkinfo; ?></a></span> | 
                ...
                <tr align="left" class="dataTrOn">
                    ...
                    <td><input name="paycodeadd" type="text" id="paycodeadd" class="input" /></td>
        ...
        <div class="bottomToolbar">
            <span class="selArea">
                ...
                <a href="javascript:DelAllNone('paymode_save.php');" onclick="return ConfDelAll(0);">删除</a>
                <span>操作：</span>
                <a href="javascript:UpOrderID('paymode_save.php');">更新排序</a>
            </span>
            <a href="#" onclick="form.submit();" class="dataBtn">更新全部</a>
        </div>
        <ul class="tipsList">
            <li>微信支付为已集成支付接口，不可删除更改</li>
        </ul>
        <div class="page">

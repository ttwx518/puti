    ...
    <body>
        ...
        <form name="form" id="form" method="post" action="infosrc_save.php?action=save">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
                ...
                <tr align="left" class="dataTr">
                    ...
                    <td>
                        <input type="text" name="srcname[]" id="srcname[]" class="inputd" value="<?php echo $row['srcname']; ?>" />
                        <input type="hidden" name="id[]" id="id[]" value="<?php echo $row['id']; ?>" />
                    </td>
                    <td><input type="text" name="linkurl[]" id="linkurl[]" class="inputd" value="<?php echo $row['linkurl']; ?>" /></td>
                    <td align="center">
                        <a href="infosrc_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=up" class="leftArrow" title="提升排序"></a>
                        <input type="text" name="orderid[]" id="orderid[]" class="inputls" value="<?php echo $row['orderid']; ?>" />
                        <a href="infosrc_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=down" class="rightArrow" title="下降排序"></a>
                    </td>
        ...
        <div class="bottomToolbar">
            <span class="selArea">
                ...
                <a href="javascript:DelAllNone('infosrc_save.php');" onclick="return ConfDelAll(0);">删除</a>
                <span>操作：</span>
                <a href="javascript:UpOrderID('infosrc_save.php');">更新排序</a>
            </span>

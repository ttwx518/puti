            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
                <tr>
                    ...
                    <td width="75%">
                        ...
                        <span class="cnote">带<span class="maroon">*</span>号表示为必填项, 可以填“游客”</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="recont" id="recont"></textarea>
                        <script>
                            var editor;
                            KindEditor.ready(function(K) {
                ...
                <tr>
                    ...
                    <td>
                        <label><input id="htop" value="true" type="checkbox" name="htop" /> 置顶[h]</label>
                        <label><input id="rtop" value="true" type="checkbox" name="rtop" /> 推荐[r]</label>
                    </td>
                </tr>
                <tr class="nb">
                    <td height="40" align="right">审　核：</td>
                    <td>
                        <label><input name="checkinfo" type="radio" value="true" checked="checked" /> 是 &nbsp;</label>

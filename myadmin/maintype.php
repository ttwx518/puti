    ...
    <body>
        ...
        <div class="bottomToolbar">
            <span class="selArea">
                ...
                <a href="javascript:DelAll('maintype_save.php');" onclick="return ConfDelAll(2);">删除</a>
                <span>操作：</span>
                <a href="javascript:UpOrderID('maintype_save.php');">排序</a> - 
                <a href="javascript:ShowAllRows();">展开</a> - 
                <a href="javascript:HideAllRows();">隐藏</a>
            </span>
            <a href="maintype_add.php" class="dataBtn">添加二级类别</a>
        </div>
        <ul class="tipsList">

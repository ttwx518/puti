    	...
    	<form>
    		<ul>
                <li>
                    ...
                    <div class="item_con"><input type="text" placeholder="请输入企业的名称"/></div>
                </li>
                <li>
                    <div class="item_tit">活动类别：</div>
                    <div class="item_con">
                        <div class="table">
                            <div class="table-cell"><input type="radio" class="item_check" name="huo" id="checkbox_a1" checked><label for="checkbox_a1"></label>植树认购活动</div>
                            <div class="table-cell"><input type="radio" class="item_check" name="huo" id="checkbox_a2"><label for="checkbox_a2"></label>爱心认养活动</div>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="item_tit">活动时间：</div>
                    <div class="item_con"><input type="text" placeholder="请输入活动时间"/></div>
                </li>
                <li>
                    <div class="item_tit">联系地址：</div>
                    <div class="item_con"><input type="text" placeholder="请输入联系人的地址"/></div>
                </li>
                <li>
                    <div class="item_tit">联  系  人：</div>
                    <div class="item_con"><input type="text" placeholder="请输入联系人"/></div>
                </li>
                <li>
        	...
        	<div class="submit"><button type="button" class="br10 b_a2 col_f combtn ">申请提交</button></div>
       	</form>
    </section>	

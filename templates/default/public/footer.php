...
<footer>
  <ul>
    <li class="<?php echo empty($f1)?'':"active"?>"><a href="index.php"><i class="icon"></i>商城首页</a></li>
    <li class="<?php echo empty($f2)?'':"active"?>"><a href="index.php?c=activity&a=default"><i class="icon"></i>种子活动</a></li>
    <li class="<?php echo empty($f3)?'':"active"?>"><a href="index.php?c=cart"><i class="icon"></i>购物车</a></li>
    <li class="<?php echo empty($f4)?'':"active"?>"><a href="index.php?c=member"><i class="icon"></i>种子会员</a></li>
<!--     <li><a href="index.php?c=member&a=order"><i class="icon"></i>我的订单</a></li> -->
  </ul>
</footer>
